	...
	public singup() {
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Verificar si el checkbox está seleccionado para saber si el cliente será
				// premium
				boolean esPremiun = chckbxNewCheckBox.isSelected();
		        JOptionPane.showMessageDialog(null, "Checkbox esPremium está: " + (esPremiun ? "Seleccionado" : "No seleccionado"));
				...
				try (Connection conn = ConexionBD.getConnection();
						...
						PreparedStatement pstmtCliente = conn
								.prepareStatement("INSERT INTO CLIENTE (DNI, ES_PREMIUN) VALUES (?, ?)")) {
