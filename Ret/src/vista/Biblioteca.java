...
public class Biblioteca extends JFrame {
	...
	public Biblioteca(Persona persona) {
...
//		try {
//			Connection conn = modelo.ConexionBD.getConnection();
...
//		try {
//			Connection conn = modelo.ConexionBD.getConnection(); // Obtener conexión
